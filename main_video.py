...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="siammask_vot_simp.onnx", required=False)
    parser.add_argument("--video", type=str, default="tennis.mp4", required=False)
    parser.add_argument("--output", type=str, default="tennis_output.mp4", required=False)
